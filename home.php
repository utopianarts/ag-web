      ...
      <div class="grid-inner">
        ...
        <div class="item">
         <div class="item-inner">
           <img src="thumbnail/gb.jpg" alt="GBTB THUMBNAIL" class="image">
           <div class="middle">
        ...
        <div class="item">
         <div class="item-inner">
           <img src="thumbnail/BISTARAI_THUMBNAIL.jpg" alt="BISTARAI THUMBNAIL" class="image">
           <div class="middle">
        ...
        <div class="item">
         <div class="item-inner">
           <img src="thumbnail/MAGNOLIA_THUMBNAIL.jpg" alt="MAGNOLIA THUMBNAI" class="image">
           <div class="middle">
        ...
        <div class="item">
         <div class="item-inner">
           <img src="thumbnail/ALIVE_THUMBNAIL.jpg" alt="ALIVE THUMBNAIL" class="image">
           <div class="middle">
        ...
        <div class="item">
         <div class="item-inner">
           <img src="thumbnail/NATADPAU_THUMBNAIL.jpg" alt="NATADPAU THUMBNAIL" class="image">
           <div class="middle">
        ...
        <div class="item">
         <div class="item-inner">
           <img src="thumbnail/RASHMINA_THUMBNAIL.jpg" alt="RASHMINA THUMBNAIL" class="image">
           <div class="middle">
        ...
        <div class="item">
         <div class="item-inner">
           <img src="thumbnail/IRO_CLAPHAM_THUMBNAIL.jpg" alt="IRO_CLAPHAM THUMBNAIL" class="image">
           <div class="middle">
        ...
        <div class="item">
         <div class="item-inner">
           <img src="thumbnail/IRO_FULHAM_THUMBNAIL.jpg" alt="IRO_FULHAM THUMBNAIL" class="image">
           <div class="middle">
      ...
      <div class="stills-frame">
        ...
        <div class="still">
          <div class="still-img">
            ...
            <img src="STILL/WEDDING_THUMBNAIL.jpg" alt="WEDDING" class="imageS"></img>
        ...
        <div class="still">
          <div class="still-img">
            <img src="STILL/FOOD_THUMBNAIL.jpg" alt="FOOD" class="imageS"></img>
            <div class="still-text">
        ...
        <div class="still">
          <div class="still-img">
            <img src="STILL/EVENTS_THUMBNAIL.jpg" alt="EVENTS THUMBNAIL" class="imageS"></img>
            <div class="still-text">
