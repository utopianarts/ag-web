...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="w3-row-padding" id="myGrid" style="margin-bottom:128px">
      <div class="w3-third">
        <img src="still/2_food/1.jpg" style="width:100%">
        <img src="still/2_food/4.jpg" style="width:100%">
        <img src="still/2_food/7.jpg" style="width:100%">
        <img src="still/2_food/10.jpg" style="width:100%">
      </div>

      <div class="w3-third">
        <img src="still/2_food/2.jpg" style="width:100%">
        <img src="still/2_food/5.jpg" style="width:100%">
        <img src="still/2_food/8.jpg" style="width:100%">
        <img src="still/2_food/11.jpg" style="width:100%">
      </div>

      <div class="w3-third">
        <img src="still/2_food/3.jpg" style="width:100%">
        <img src="still/2_food/6.jpg" style="width:100%">
        <img src="still/2_food/9.jpg" style="width:100%">
      </div>
    </div>
